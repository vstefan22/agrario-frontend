  ...
  return (
    ...
    >
      <div className="flex justify-between py-2 space-x-4">
        <ItemImage id={data.id} image={data.image} className="border-[0.16px]" />
        <div className="flex flex-col">
          ...
          <div className="flex justify-end items-center pt-5 gap-3">
            ...
            />
            <p className="text-[14px] text-gray-dark-100 font-400 mr-3">Analyse Plus</p>
            <Button
            ...
            <Button variant="bluePrimary" type="button" onClick={handleFetchOffers}>
              Angebote einholen
            </Button>
          </div>
        </div>
