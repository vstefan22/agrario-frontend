...
import PasswordChangeRequest from "./components/auth/PasswordChangeRequest";
              ...
              element={
                <ProtectedLayout>
                  <Routes>
                    ...
                    />
                    <Route path="/my-plots/analyse-plus" element={<AnalysePlusCart />} />
                    <Route path="/my-plots/details" element={<PlotDetails />} />
                    <Route path="/my-plots/offer-preparation" element={<OfferPreparation />} />
                    <Route path="/my-offers" element={<MyOffers />} />
                    <Route path="/my-offers/details" element={<OfferDetails />} />
                    <Route path="/friend-invite" element={<FriendInvite />} />
                    <Route path="/questions-help" element={<QuestionsHelpLandowner />} />
              ...
              element={
                <ProtectedLayout>
                  <Routes>
                    ...
                    <Route path="/registered-plots" element={<RegisteredPlots />} />
                    <Route path="/registered-plots/parcel-details" element={<ParcelDetails />} />
                    <Route path="/my-watchlist" element={<MyWatchlist />} />
                    <Route path="/active-auctions" element={<ActiveAuctions />} />
                    <Route path="active-auctions/details" element={<AuctionDetails />} />
                    <Route path="active-auctions/place-a-bid" element={<PlaceABid />} />
                    <Route path="active-auctions/thanks" element={<ThankYouInterest />} />
                    <Route path="my-auctions" element={<MyAuctions />} />
                    <Route path="my-auctions/details" element={<MyAuctionDetails />} />
                    <Route path="/questions-help" element={<QuestionsHelpDeveloper />} />
                    <Route path="/support" element={<Support />} />
                    <Route path="/support/:chatId" element={<Support />} />
                    <Route path="*" element={<NotFound />} />
