...
const OfferDetails = () => {
  ...
  const [formData, setFormData] = useState<OfferType>({
    ...
    no_usage_restriction: offer?.no_usage_restriction || false,
    wind_energy_restriction: offer?.wind_energy_restriction || false,
    solar_energy_restriction: offer?.solar_energy_restriction || false,
    energy_storage_restriction: offer?.energy_storage_restriction || false,
    eco_enhancements_restriction: offer?.eco_enhancements_restriction || false,
