...
const OfferDetails = () => {
  ...
  const [formData, setFormData] = useState<OfferPreparationType>({
    ...
    preferred_regionality: optionsMapReverse[offer?.preferred_regionality || ""],
    ...
    solar_energy_restriction: offer?.criteria?.solar_energy_restriction || false,
    energy_storage_restriction: offer?.criteria?.energy_storage_restriction || false,
    eco_enhancements_restriction: offer?.criteria?.eco_enhancements_restriction || false,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isFormValidate) {
      ...
      const updateOfferData = {
        ...formData,
        documented_offers: offer?.documented_offers ? offer.documented_offers : [],
        criteria: {
          no_usage_restriction: formData.no_usage_restriction,
          wind_energy_restriction: formData.wind_energy_restriction,
          solar_energy_restriction: formData.solar_energy_restriction,
