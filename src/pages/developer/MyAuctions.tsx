...
import { filterActiveAuctionsData, sortActiveAuctionsData } from "../../utils/helper-functions";
...
const MyAuctions = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col px-7 pt-4">
      <h1 className="text-[32px] font-bold text-black-muted">Meine Auktionen</h1>
      ...
      <div className="flex mt-6 flex-col gap-6">
        ...
        {sortedData.length > 0 ? (
          <GenericList
            data={sortedData}
            renderItem={(offer) => (
              <ActiveAuctionsItem key={offer.identifier} data={offer} detailsType="myAuction" />
            )}
          />
        ) : (
