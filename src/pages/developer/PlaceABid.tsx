  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isFormValidate) {
        ...
        formDataSend.append("contracted_term_month", formData.contracted_term_month || "");
        formDataSend.append(
        ...
        <form className="w-1/2">
          <div className="bg-white border-[1px] border-[#D9D9D9] p-6 rounded-2xl">
            ...
            <Select
              ...
              options={bidOptions}
              placeholder="Ja/Nein/Keine Angabe"
              divClassName={`${errors.shares_project_company ? "mt-8 mb-4" : "my-8"}`}
            />
          ...
          {(errors.accept_privacy_policy || errors.accept_terms || errors.other) && (
            <div className="flex flex-col mb-4 gap-2">
              {errors.accept_privacy_policy && (
                <span className="text-red-500 text-sm nowrap">{errors.accept_privacy_policy}</span>
              )}
              {errors.accept_terms && (
          ...
          <div className="flex justify-end gap-6">
            <Button variant="blueSecondary" onClick={() => navigate("../active-auctions/")}>
              Abbrechen
            </Button>
