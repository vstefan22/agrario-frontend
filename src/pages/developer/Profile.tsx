              ...
              {isChecked ? (
                ...
                <>
                  <PackageCard
                    ...
                    features={PACKAGE_FEATURES.free}
                    onClick={() => {}}
                    buttonText={user?.tier === "FREE" ? "Status aktiv" : "Paket buchen"}
                  ...
                  <PackageCard
                    ...
                    description="All the basic features to boost your freelance career"
                    features={PACKAGE_FEATURES.premium}
                    buttonText={user?.tier === "PREM" ? "Status aktiv" : "Paket buchen"}
                  ...
                  <PackageCard
                    ...
                    price="Preis auf Anfrage"
                    features={PACKAGE_FEATURES.onRequest}
                    buttonText={user?.tier === "ENTE" ? "Status aktiv" : "Sales kontaktierten"}
                    onClick={handlePriceOnRequest}
