...
import { sortPlotsSearchData, filterPlotsSearchData } from "../../utils/helper-functions";
...
const MyWatchlist = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col px-7 pt-4">
      <h1 className="text-[32px] font-bold text-black-muted">Meine Watchlist</h1>
      ...
      {sortedData.length > 0 ? (
        <GenericList
          data={sortedData}
          renderItem={(plot) => <MyWatchlistItem key={plot.parcel.id} data={plot} />}
        />
      ) : (
