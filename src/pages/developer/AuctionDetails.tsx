    ...
    <div className="bg-gray-100 min-h-screen flex flex-col px-7 pt-4">
      <div>
        ...
        <div className="flex items-center gap-4 mb-4">
          <p className="text-black-muted font-semibold">{auctionOffer?.parcels[0].id}</p>
      ...
      <div className="ml-auto mt-8 flex gap-6">
        <Button type="button" variant="blueSecondary" onClick={handleDownloadGeodata}>
          Download Geodaten
        </Button>
        <Button type="button" variant="bluePrimary" className="w-[188px]" onClick={handlePlaceABid}>
          Gebot abgeben
        </Button>
      </div>
    </div>
